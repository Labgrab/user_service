...
(
    ...
    constraint name_check check ((name ~ '^[A-Za-z0-9_\-\. ]+$'::text)),
    constraint surname_check check ((surname ~ '^[A-Za-z0-9_\-\. ]+$'::text)),
    constraint patronymic_check check ((patronymic ~ '^[A-Za-z0-9_\-\. ]+$'::text)),
